...
$TaskDescription = "Do shit for PepeLaugh Server"
$TaskScriptPath = "C:\script\ShitForPepeLaughSrv.ps1"
...
New-NetIPAddress -InterfaceAlias "Ethernet" -IPAddress 10.6.68.176 -PrefixLength 24 -DefaultGateway 10.6.68.1
